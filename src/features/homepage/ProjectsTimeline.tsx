      ...
      >
        ...
        <Header as="h3">
          <Header.Content>
            Adopt-a-Cat
            <Header.Subheader>
              Small Redux example using CatAPI to fetch random cat images and
              information
            </Header.Subheader>
          </Header.Content>
        </Header>
        <p>
          Adopt-a-Cat is using Redux, RTK, to manage a cat "inventory" and an
          admin panel to approve/reject adoption requests.
        </p>
        <p>
          Using some re-usable components and building the page based on data
          being fetched/stored within Redux.
        </p>
      </VerticalTimelineElement>
    </VerticalTimeline>
  );
